# ChemFinder
ChemFinder is a open source search functionality where one can easily get information of a particular chemical compound. Combining curated chemical databases with real-time LLM insights, ChemFinder aims to be the ultimate hub for chemical data access, analysis, and predictive discovery.
